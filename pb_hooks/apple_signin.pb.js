...
//   APPLE_CLIENT_SECRET  -> the client-secret JWT generated in the
//                           Admin UI > Auth providers > Apple > "Generate secret"
//                           popup. It expires (max ~6 months) — regenerate and
//                           update this env var before it lapses.
//
...
routerAdd("POST", "/apple-signin", (e) => {
  const clientId = $os.getenv("APPLE_CLIENT_ID") || "com.strikefeed.myapp";
  const clientSecret = $os.getenv("APPLE_CLIENT_SECRET");
  if (!clientSecret) {
