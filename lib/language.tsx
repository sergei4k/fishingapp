...
const translations = {
  ru: {
    ...
    unfollow: "Отписаться",
    unfollowConfirmTitle: "Отписаться?",
    unfollowConfirmMessage: "Вы уверены, что хотите отписаться?",
    ...
    registeringAgree: "Регистрируясь, вы соглашаетесь с нашими",
    loginAgree: "Входя, вы соглашаетесь с нашими",
    and: "и",
    report: "Пожаловаться",
  ...
  en: {
    ...
    unfollowConfirmMessage: "Are you sure you want to unfollow?",
    ...
    reportFailed: "Could not submit the report. Please try again later.",
    blockUser: "Block user",
    blockUserConfirm: "Block user?",
    blockUserMessage: "You will no longer see this user's profile, catches, or comments.",
    userBlocked: "User blocked",
    blockedUsers: "Blocked users",
    noBlockedUsers: "No blocked users",
    unblock: "Unblock",
    unblockUserConfirm: "Unblock user?",
