...
const speciesOptions: SpeciesOption[] = [
  ...
  { id: "taimen",      labelRu: "Сибирский таймень", labelEn: "Siberian Taimen",  scientificName: "Hucho taimen", habitat: "freshwater" },
  ...
  { id: "tolstolobik", labelRu: "Пёстрый толстолобик", labelEn: "Bighead Carp",  scientificName: "Hypophthalmichthys nobilis", habitat: "freshwater" },
  ...
  { id: "sudak_morskoy", labelRu: "Судак канадский", labelEn: "Walleye",          scientificName: "Sander vitreus", habitat: "freshwater" },
  ...
  { id: "spongebob",     labelRu: "Спанч Боб",        labelEn: "Spongebob",          scientificName: "Porifera", habitat: "saltwater" },
  { id: "patrick",       labelRu: "Патрик",           labelEn: "Patrick",            scientificName: "Asteroidea", habitat: "saltwater" },
];
...
export function getSpeciesOptions(language: "ru" | "en" = "ru"): Array<{ id: string; label: string; labelRu: string; labelEn: string; scientificName: string; habitat: SpeciesHabitat }> {
  const easterEggIds = ["spongebob", "patrick"];
  ...
  return speciesOptions
    ...
    .sort((a, b) => {
      const aEasterEggIndex = easterEggIds.indexOf(a.id);
      const bEasterEggIndex = easterEggIds.indexOf(b.id);
      if (aEasterEggIndex !== -1 || bEasterEggIndex !== -1) {
        if (aEasterEggIndex === -1) return -1;
        if (bEasterEggIndex === -1) return 1;
        return aEasterEggIndex - bEasterEggIndex;
      }
